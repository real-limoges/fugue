  ...
  defp aliases do
    [
      ...
      "assets.setup": [
        ...
        "cmd mkdir -p priv/static/vendor/bloom && cp assets/vendor/bloom/pkg/bloom_bg.wasm assets/vendor/bloom/pkg/bloom.js priv/static/vendor/bloom/"
      ],
