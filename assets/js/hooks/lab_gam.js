...
function bandNB(pred) {
  return {
    lower: pred.mu.map((mu, i) => Math.max(0, mu - Z_95 * Math.sqrt(mu + mu * mu * pred.sigma[i]))),
    ...
    layers: [
      {
        ...
        dashed: true,
        family: "Gaussian",
        formula: makeFormula("Gaussian", "sqft", "linear"),
      },
      {
        id: "gam",
        color: COLOR_SHAPE,
        family: "Gaussian",
        formula: makeFormula("Gaussian", "sqft", "smooth_mu"),
        bandFn: bandSymmetricSigma,
      },
      {
        id: "gamlss",
        color: COLOR_SHAPE_SPREAD,
        family: "Gamma",
        formula: makeFormula("Gamma", "sqft", "smooth_spread"),
        bandFn: bandGammaCV,
      },
    ],
  },
    ...
    layers: [
      {
        ...
        dashed: true,
        family: "Poisson",
        formula: makeFormula("Poisson", "hour", "linear"),
      },
      {
        id: "gam",
        color: COLOR_SHAPE,
        family: "Poisson",
        formula: makeFormula("Poisson", "hour", "smooth_mu"),
        bandFn: bandPoisson,
      },
      {
        id: "gamlss",
        ...
        formula: makeFormula("NegativeBinomial", "hour", "smooth_spread"),
        bandFn: bandNB,
      },
    ],
  },
    ...
    layers: [
      {
        ...
        dashed: true,
        family: "Gaussian",
        formula: makeFormula("Gaussian", "dist", "linear"),
      },
      {
        id: "gam",
        color: COLOR_SHAPE,
        family: "Gaussian",
        formula: makeFormula("Gaussian", "dist", "smooth_spread"),
        bandFn: bandSymmetricSigma,
      },
      {
        id: "gamlss",
        color: COLOR_SHAPE_SPREAD,
        family: "StudentT",
        formula: makeFormula("StudentT", "dist", "smooth_spread"),
        bandFn: bandSymmetricSigma,
      },
    ],
  },
  ...
  shot_success: {
    ...
    layers: [
      ...
      },
      {
        ...
        color: COLOR_SHAPE_SPREAD,
        family: "Beta",
        formula: makeFormula("Beta", "dist", "smooth_spread"),
        bandFn: bandBeta,
      },
    ],
  },
...
export const LabGam = {
  ...
  fitDataset(id) {
    ...
    for (const layer of cfg.layers) {
      const model = this._wasm.fitWithConfig(
        yJson,
        dataJson,
        layer.formula,
        layer.family,
  ...
  renderDataset(id) {
    ...
    for (const layer of cfg.layers) {
      ...
      const lineAttrs = {
        ...
        stroke: layer.color,
        "stroke-width": layer.dashed ? "1.5" : "2",
        fill: "none",
        opacity: layer.dashed ? "0.55" : "1",
      }
